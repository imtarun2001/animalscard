export const animalsData = [
    {
        ...
        name : "Panda",
        specie : "Mammal",
        description : "Pandas, also known as giant pandas, are one of the most recognizable and beloved animals in the world. With large black patches around their eyes, over their ears, and across their bodies.Giant pandas are primarily herbivores, with bamboo comprising about 99% of their diet. They spend around 12 to 16 hours each day eating, consuming up to 40 pounds of bamboo. Despite having a digestive system typical of carnivores, pandas have evolved to process bamboo through a combination of strong jaw muscles and a pseudo-thumb—an enlarged wrist bone—that helps them grasp the bamboo stalks.Adult giant pandas typically measure between 1.2 to 1.9 meters (4 to 6 feet) in length, including the tail. They weigh between 70 to 100 kilograms (154 to 220 pounds), though males can sometimes weigh more.Pandas are known for their distinctive black-and-white fur. The black fur covers their ears, eye patches, limbs, and shoulders, while the rest of their body is white. This unique coloration may help with camouflage in their natural habitat, which consists of dense forests and snowy environments.",
        image : "https://media.istockphoto.com/id/175009379/photo/giant-panda-bear-eating-bamboo.jpg?s=612x612&w=0&k=20&c=EYUlXKzjxe23OSXHO9jlugQhH_VWtF1-2NUaOSXsijA="
    },
    {
        id : 2,
        name : "Monkey",
        ...
        image : "https://media.istockphoto.com/id/629628952/photo/bonnet-monkey.jpg?s=612x612&w=0&k=20&c=UlCED-gnWw3fgiYQxIGEf-Fqbn-H0nJ0aH9rfj-12ac="
    },
    {
        id : 3,
        name : "Owl",
        ...
        image : "https://media.istockphoto.com/id/1323187200/photo/spotted-owlet.jpg?s=612x612&w=0&k=20&c=Y0103wykL7LJBhBNUi2HH3uNlCuRZ3I2xVrZcUgryt4="
    ...
    },
    {
        ...
        image : "https://media.istockphoto.com/id/180699358/photo/peacock.jpg?s=612x612&w=0&k=20&c=10hdZK3_qCEWp4-cPm4cXFBVXm2GxOS1nXYZB8kmYBQ="
    },
    {
        id : 5,
        name : "Pigeon",
        ...
        image : "https://media.istockphoto.com/id/1391570531/photo/rock-pigeon-or-rock-dove-sitting-on-wall-of-a-building-in-urban-locality.jpg?s=612x612&w=0&k=20&c=6KIYb4K2NOuGbnqXPIQKS7heYri9IJHfp0EEelMCeA8="
    ...
    },
    {
        ...
        image : "https://media.istockphoto.com/id/115962508/photo/zebra.jpg?s=612x612&w=0&k=20&c=edasI8Wc4_BQ1KL9Mw2LL__MdtnecACK0Znh5rDRpHU="
    },
    {
        id : 9,
        name : "Fox",
        specie : "Mammal",
        description : "The red fox is the subject of considerable folklore. The red fox has the largest natural distribution of any land mammal except human beings. In the Old World it ranges over virtually all of Europe, temperate Asia, and northern Africa, and in the New World it inhabits most of North America. Introduced to Australia, it has established itself throughout much of that continent. The red fox has a coat of long guard hairs, soft fine underfur that is typically a rich reddish brown, often a white-tipped tail, and black ears and legs. Colour, however, is variable. In North America black and silver coats are found, with a variable amount of white or white-banded hair occurring in a black coat.",
        image : "https://media.istockphoto.com/id/494415298/photo/red-fox.jpg?s=612x612&w=0&k=20&c=bBD7Vk5noYDhl9qn0FWfMUIL542aQERYZC-Fccs5ZMk="
    },
    {
        id : 10,
        name : "Tiger",
        specie : "Mammal",
        description : "Tigers are among the largest cats in the world, and the Amur tiger is the largest subspecies with males weighing up to 660 pounds (300 kilograms) and measuring 10 feet (3 meters).Tigers have reddish-orange coats with prominent black stripes, white bellies and white spots on their ears. Like a human fingerprint, no two tigers have the exact same markings. Because of this, researchers can use stripe patterns to identify different individuals when studying tigers in the wild. Tigers are powerful hunters with sharp teeth, strong jaws and agile bodies. They are the largest terrestrial mammal whose diet consists entirely of meat; the largest tiger ever recorded was an Amur tiger.",
        image : "https://media.istockphoto.com/id/1251700853/photo/amur-tiger-walking-in-river-water-danger-animal-tajga-russia-animal-in-green-forest-stream.jpg?s=612x612&w=0&k=20&c=X7c6xkZYU0b5tVx6ipF5viUj4Yp0qqbih2t9U9eo1VI="
    },
    {
        id : 11,
        name : "Dolphin",
        specie : "Mammal",
        description : "A dolphin is a mammal, and needs to breathe air through its blowhole, just as whales and porpoises do.Dolphins have smooth skin, flippers, and a dorsal fin. They have a long, slender snout with about 100 teeth, and a streamlined body. The single blowhole on top of their head has a flap that opens to reveal a pair of nostrils, which dolphins use for breathing when they surface.When they sleep, they don't sink. Rather, they float about 10 inches (25 centimeters) below the surface of the water. Small movements of their flukes periodically push them up to the surface so they can take a breath through their blowhole.Dolphins have an eye on each side of their head. Each eye moves independently of the other, so dolphins can see ahead, to the side, and behind them. They can also see very well both underwater and above water.",
    ...
    },
    {
        ...
        image : "https://media.istockphoto.com/id/638460056/photo/single-lion-standing-proudly-on-a-small-hill.jpg?s=612x612&w=0&k=20&c=OyEKBg7dkPcR9wD3fwTUzXJHu7kdxgG3AgdKuMgBMf0="
    },
    {
        id : 13,
        name : "Horse",
        specie : "Mammal",
        description : "In prehistoric times the wild horse was probably first hunted for food. Research suggests that domestication had taken place by approximately 6,000 years ago. It is supposed that the horse was first used by a tribe of Indo-European origin that lived in the steppes north of the chain of mountains adjacent to the Black and Caspian seas. Influenced by climate, food, and humans, the horse rapidly acquired its present form.Clydesdales ClydesdalesA team of Clydesdales pulling a plow at a draft horse demonstration.The relationship of the horse to humans has been unique. The horse is a partner and friend. It has plowed fields and brought in the harvest, hauled goods and conveyed passengers, followed game and tracked cattle, and carried combatants into battle and adventurers to unknown lands. It has provided recreation in the form of jousts, tournaments, carousels, and the sport of riding. The influence of the horse is expressed in the English language in such terms as chivalry and cavalier, which connote honor, respect, good manners, and straightforwardness.",
        image : "https://media.istockphoto.com/id/1209008843/photo/the-bay-horse-gallops-on-the-grass.jpg?s=612x612&w=0&k=20&c=iFVozGRChWgKih-g_aaP_uSqIKbIvTZOGkXn75dC16s="
    },
    {
        id : 14,
        name : "Octopus",
    ...
    },
    {
        ...
        name : "Giraffe",
        specie : "Mammal",
        description : "The giraffe is a large African hoofed mammal belonging to the genus Giraffa. It is the tallest living terrestrial animal and the largest ruminant on Earth. Traditionally, giraffes have been thought of as one species, Giraffa camelopardalis, with nine subspecies. Most recently, researchers proposed dividing them into four extant species due to new research into their mitochondrial and nuclear DNA, and individual species can be distinguished by their fur coat patterns. Six valid extinct species of Giraffa from Africa and Pakistan are known from the fossil record.The giraffe's distinguishing characteristics are its extremely long neck and legs, horn-like ossicones, and spotted coat patterns. It is classified under the family Giraffidae, along with its closest extant relative, the okapi. Its scattered range extends from Chad in the north to South Africa in the south and from Niger in the west to Somalia in the east.",
        image : "https://media.istockphoto.com/id/1902136753/photo/giraffe-in-the-wild-standing.jpg?s=612x612&w=0&k=20&c=blI5R4zcxT3J6aL9kSJ404dSjbzSDNGe1PB_Avh_FEE="
    },
]